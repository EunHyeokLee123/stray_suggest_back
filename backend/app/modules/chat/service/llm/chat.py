...
def extract_filters(user_text: str, use_llm=True, verbose=True):
    """
    ...
    llm_result = extract_filters_with_openai_v2(
        normalized_text=normalized_text,
...
def extract_filters_with_openai_v2(
    normalized_text: str,
    original_text: str,
    ...
    schema = {
        ...
        "schema": {
            ...
            "properties": {
                "sido": {
                    "type": ["string", "null"],
                    "enum": VALID_SIDO + [None]
                },
                "kind": {
                    "type": ["string", "null"],
                    "enum": VALID_KIND + [None]
                },
                "breed": {
                    "type": ["string", "null"],
                    "enum": VALID_BREEDS + [None]
                },
                "colors": {
                    "type": "array",
                    "items": {
